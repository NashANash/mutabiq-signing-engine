...
def build_invoice_xml(data):
    ...
    if has_items:
        ...
        for item in items:
            ...
            # Description
            item_name = ET.SubElement(inv_line, qname("cbc", "Item"))
            # ملاحظة: UBL العادي يستخدم cac:Item، بس هنا نبقيها بسيطة
            # لو حاب نطابق 100% نقدر نعدلها في مرحلة لاحقة

            # TaxTotal + TaxCategory
